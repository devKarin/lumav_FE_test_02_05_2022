...
export default function ProductCounter() {
    ...
    return (
        <Card>
            <p className={classes.counter}>Products in cart: <span className={classes.counterspan}>{totalCount}</span></p>
            {totalCount > 0 && <nobr><p className={classes.total}>Total: <span className={classes.counterspan}>{runningTotal.toFixed(2)} space$</span></p></nobr>}
